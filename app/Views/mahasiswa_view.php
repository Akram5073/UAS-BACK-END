...
<head>
  ...
  <style>
    body {
      background: linear-gradient(135deg,rgb(164, 139, 197),rgb(124, 57, 156));
    }
    .container {
      max-width: 1200px;
      margin-top: 30px;
    ...
    .btn-primary {
      ...
      border-color: #6f42c1; /* Border tombol ungu */
    }
    .btn-primary:hover {
      background-color: #5a32a1; /* Warna ungu lebih gelap saat hover */
      border-color: #5a32a1; /* Border tombol ungu lebih gelap saat hover */
    }
  </style>
</head>
